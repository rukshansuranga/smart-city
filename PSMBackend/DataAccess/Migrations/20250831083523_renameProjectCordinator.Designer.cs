...
namespace PSMDataAccess.Migrations
{
    ...
    [Migration("20250831083523_renameProjectCordinator")]
    partial class renameProjectCordinator
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PSMModel.Models.ProjectCordinator", b =>
                {
                    b.Property<int>("ProjectCordinatorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ProjectCordinatorId"));
                    ...
                    b.HasKey("ProjectCordinatorId");

                    b.HasIndex("CordinatorId");

                    b.HasIndex("ProjectId");

                    b.ToTable("ProjectCordinators");

                    b.HasData(
                        new
                        {
                            ProjectCordinatorId = 1,
                            AssignDate = new NodaTime.LocalDate(2025, 8, 24),
                            CordinatorId = "0c895075-b8e6-48f9-bb9e-2c9db9d7207a",
                            CreatedAt = new NodaTime.LocalDateTime(1, 1, 1, 0, 0),
                            IsActive = true,
                        ...
                        new
                        {
                            ProjectCordinatorId = 2,
                            AssignDate = new NodaTime.LocalDate(2025, 8, 24),
                            CordinatorId = "43e63068-a5fd-4a45-acfb-0383ff4d45ea",
                            CreatedAt = new NodaTime.LocalDateTime(1, 1, 1, 0, 0),
                            IsActive = true,
                        ...
                        new
                        {
                            ProjectCordinatorId = 3,
                            AssignDate = new NodaTime.LocalDate(2025, 8, 24),
                            CordinatorId = "6c35c5ad-2f70-4c3f-aa44-c94bc61d10a1",
                            CreatedAt = new NodaTime.LocalDateTime(1, 1, 1, 0, 0),
                            IsActive = true,
                            Note = "Can you give support on the project?",
                            ProjectId = 2,
            ...
            modelBuilder.Entity("PSMModel.Models.ProjectInspection", b =>
                {
                    ...
                    b.HasIndex("ProjectCordinatorId");
            ...
            modelBuilder.Entity("PSMModel.Models.ProjectCordinator", b =>
                {
                    b.HasOne("PSMModel.Models.User", "Cordinator")
                        .WithMany()
            ...
            modelBuilder.Entity("PSMModel.Models.ProjectInspection", b =>
                {
                    b.HasOne("PSMModel.Models.ProjectCordinator", "ProjectCordinator")
                        .WithMany()
                        .HasForeignKey("ProjectCordinatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProjectCordinator");
                });
